...
export default function SelectionTemplatesClient({ templates }: { templates: SelectionTemplateRow[] }) {
  const [selectedTemplate, setSelectedTemplate] = useState<SelectionTemplateRow | null>(null);
            ...
            <CardContent>
              ...
              <div className="flex items-center gap-6 text-sm">
                ...
                <span className="text-muted-foreground">
                  Result Options: {(template.resultOptions ? JSON.parse(template.resultOptions) as string[] : []).join(" / ")}
                </span>
              </div>
            ...
            <CardContent className="pt-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4 max-w-md">
                <div>
                  ...
                  <Input defaultValue={(template.resultOptions ? JSON.parse(template.resultOptions) as string[] : []).join(", ")} className="mt-1" disabled />
                </div>
