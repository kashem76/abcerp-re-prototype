...
export interface WorkBoardProps {
  ...
  attentionItems: { text: string; severity: "red" | "amber" }[];
  activityLog: { time: string; user: string; type: "note" | "system"; text: string }[];
}
...
export default function WorkBoardClient({
  land, workSteps, departmentMembers, attentionItems, activityLog,
}: WorkBoardProps) {
